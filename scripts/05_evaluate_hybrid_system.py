...
# Knowledge graph and vocab paths
KG_DIR = NEUROSYMBOLIC_DIR / "knowledge_graphs"
RULES_PATH = NEUROSYMBOLIC_DIR / "data" / "rules" / "clinical_rules_expanded.json"
VOCAB_DIR = NEUROSYMBOLIC_DIR / "data"
...
def main():
    ...
    reasoner = HybridNeurosymbolicReasoner(
        kg_dir=str(KG_DIR),
        hazard_detector=trained_detector,
