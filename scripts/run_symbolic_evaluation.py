...
def evaluate_symbolic_only():
    ...
    print(f"  [OK] Patient KG: {patient_kg.number_of_nodes():,} nodes, {patient_kg.number_of_edges():,} edges")
    print(f"  [OK] Clinical Rules KG: {rules_kg.number_of_nodes()} nodes, {rules_kg.number_of_edges()} edges")
    print(f"  [OK] Care Pathway KG: {pathway_kg.number_of_nodes()} nodes, {pathway_kg.number_of_edges()} edges")
    print()
    ...
    print(f"  [OK] Completed {len(results)} evaluations")
    print()
